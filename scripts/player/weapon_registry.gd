...
const WEAPONS := [
	...
	{"name": "Greataxe",         "file": "greataxe",         "category": "axe",     "damage": 14, "attack_speed": 0.9, "mining_power": 1.8, "desc": "A massive two-handed greataxe with a broad flared bit — slow to swing, but it cleaves through foe and timber in one ruinous arc."},
	...
	{"name": "Flanged Mace",     "file": "mace_round",       "category": "mace",    "damage": 10, "attack_speed": 1.2, "mining_power": 1.3, "desc": "A flanged steel head that delivers reliable, bone-jarring blows."},
	...
	{"name": "Warhammer",        "file": "maul_iron_1",      "category": "maul",    "damage": 12, "attack_speed": 1.0, "mining_power": 1.3, "desc": "A forged warhammer balanced just enough to swing without losing its punch."},
	{"name": "Great Maul",       "file": "maul_iron_2",      "category": "maul",    "damage": 13, "attack_speed": 1.0, "mining_power": 1.3, "desc": "A solid great maul that turns slow swings into devastating impacts."},
